...
when an operator-local Lens adds an episode
  then its group is determined by the operator and Lens together
  ...
  and the episode is unavailable from the shared global group

when a global Lens adds an episode
  then the episode enters the one global group shared by every global Lens and every operator
