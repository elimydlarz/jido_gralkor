defmodule Gralkor.LegacyFlushGeneralisationFunctionalTest do
  ...
  describe "where legacy generalisation on flush is enabled" do
    describe "when an implicit-default captured transcript is flushed successfully" do
  ...
  describe "where legacy generalisation on flush is disabled" do
    describe "when an implicit-default captured transcript is flushed successfully" do
