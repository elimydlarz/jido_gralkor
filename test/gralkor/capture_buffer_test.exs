defmodule Gralkor.CaptureBufferTest do
  ...
  describe "ex-capture-buffer > append/6when called again for the same session_id" do
  ...
  describe "ex-capture-buffer > append/6when called for multiple session_ids" do
  ...
  describe "ex-capture-buffer > append/6when called for an existing session_id with a different group_id" do
  ...
  describe "ex-capture-buffer > append/6when called for an existing session_id with a different agent_name" do
  ...
  describe "ex-capture-buffer > append/6when called for an existing session_id with a different user_name" do
  ...
  describe "ex-capture-buffer > append/6if agent_name is missing or blank" do
  ...
  describe "ex-capture-buffer > append/6if user_name is missing or blank" do
