defmodule Gralkor.Reflection.Artefact do
  ...
  @enforce_keys [:id, :reflection, :payload]
  defstruct [:id, :reflection, :payload]
  ...
  def new(reflection, payload) do
    id = "reflection-#{System.system_time(:microsecond)}-#{System.unique_integer([:positive])}"
    %__MODULE__{id: id, reflection: reflection, payload: payload}
  end

  def new(id, reflection, payload) do
    %__MODULE__{id: id, reflection: reflection, payload: payload}
  end
