...
- Public search validates every selected Destination, result type, and positive result limit before any query begins, defaults an empty selection to packaged operator memory and global generalisations, and searches distinct Destinations concurrently. Results retain requested Destination order and identify their Destination; entity and edge type filters apply to nodes and facts respectively.
