...
- *Reflection* — an asynchronous post-ingestion process whose repository YAML Chain of Thought runs ordered inference steps over the completed operation's lensed representations, may direct any configured tool, and stores one artefact at the destination named by the Reflection. Reflection names form their own search namespace rather than naming Lenses.
